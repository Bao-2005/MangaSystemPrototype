...
export const MENU_PERMISSIONS = {
  dashboard: [ROLES.ADMIN, ROLES.MANGAKA, ROLES.ASSISTANT, ROLES.TANTOU_EDITOR, ROLES.EDITORIAL_BOARD, ROLES.EDITOR_IN_CHIEF],
  series: [ROLES.ADMIN, ROLES.MANGAKA, ROLES.ASSISTANT, ROLES.TANTOU_EDITOR, ROLES.EDITORIAL_BOARD, ROLES.EDITOR_IN_CHIEF],
