...
export const MENU_PERMISSIONS = {
  dashboard: [ROLES.ADMIN, ROLES.EDITORIAL_OFFICE_ADMIN, ROLES.MANGAKA, ROLES.ASSISTANT, ROLES.TANTOU_EDITOR, ROLES.EDITORIAL_BOARD, ROLES.EDITOR_IN_CHIEF],
  series: [ROLES.ADMIN, ROLES.EDITORIAL_OFFICE_ADMIN, ROLES.MANGAKA, ROLES.ASSISTANT, ROLES.TANTOU_EDITOR, ROLES.EDITORIAL_BOARD, ROLES.EDITOR_IN_CHIEF],
  'series/new': [ROLES.MANGAKA],
  voting: [ROLES.EDITORIAL_BOARD, ROLES.ADMIN, ROLES.EDITOR_IN_CHIEF],
  chapters: [ROLES.MANGAKA, ROLES.ASSISTANT, ROLES.TANTOU_EDITOR, ROLES.ADMIN, ROLES.EDITOR_IN_CHIEF],
  manuscripts: [ROLES.MANGAKA, ROLES.TANTOU_EDITOR, ROLES.ADMIN, ROLES.EDITOR_IN_CHIEF],
  'ranking/votes': [ROLES.EDITORIAL_BOARD, ROLES.ADMIN],
  ranking: [ROLES.ADMIN, ROLES.MANGAKA, ROLES.TANTOU_EDITOR, ROLES.EDITORIAL_BOARD, ROLES.EDITOR_IN_CHIEF],
  decisions: [ROLES.EDITORIAL_BOARD, ROLES.ADMIN, ROLES.EDITOR_IN_CHIEF],
  chief: [ROLES.EDITOR_IN_CHIEF],
...
// BR-Chief-Editor-Override: Check if user is Editor-in-Chief
export function isEditorInChief(user) {
  return user?.roles?.includes(ROLES.EDITOR_IN_CHIEF) || false;
}
